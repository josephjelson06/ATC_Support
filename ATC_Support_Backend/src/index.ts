...
import hardwareAssetsRouter from './routes/hardwareAssets';
import hardwareCatalogRouter from './routes/hardwareCatalog';
...
import supportSessionsRouter from './routes/supportSessions';
import supportTopicsRouter from './routes/supportTopics';
...
app.use('/api/support-sessions', authMiddleware, supportSessionsRouter);
app.use('/api/support-topics', authMiddleware, supportTopicsRouter);
...
app.use('/api', authMiddleware, hardwareAssetsRouter);
app.use('/api', authMiddleware, hardwareCatalogRouter);
