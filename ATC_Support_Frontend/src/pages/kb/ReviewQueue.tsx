    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Resolved tickets become draft knowledge suggestions that can be saved as draft content or published immediately.</p>
        </div>
